...
public class PhoneBook {
    ...
    public void setNickname(String nickname) throws LoginDuplicationException {
        boolean condition = true; //Some condition that tell us that login already exists
        if(!condition) {
            this.nickname = nickname;
        }
        else{
            throw new LoginDuplicationException(View.LOGIN_DUPLICATION_EXCEPTION, nickname);
        }
    }
